...
\abst{
  The MAIKo TPC enable us to project tracks of charged particles
  onto two planes perpendicular and parallel to the beam axis, and to acquire these projections as two images.
  ...
  This conventional method requires complex algorithms and large computing power.
  Recently neural networks have been widely employed for the image recognition.
  In the present work, we developed a new method to analyze track images obtained by the MAIKo TPC using neural networks.
