...
\abst{
  ...
  \textcolor{red}{One often analyzes} them with the Hough transformation to find lines in images.
  This conventional method requires \textcolor{red}{a} complex algorithms and a large computing power.
...
On the other hand, Figure~\ref{fig:false} shows a background event due to the quenching gas
...
\section{\textcolor{red}{Previous method using Hough transformation}}
...
\section{New method \textcolor{red}{using neural network}}
...
\begin{wrapfigure}{r}{25zw}
  \vspace{-6zw}
  \centering
  \includegraphics[clip, width=25zw]{eps/compare_mono_v3.eps}
