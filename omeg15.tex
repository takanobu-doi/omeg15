...
\begin{figure}
  \begin{minipage}{0.4\columnwidth}
    \centering
    \includegraphics[clip, width=0.8\columnwidth]{eps/MAIKo.eps}
    \caption{MAIKo TPC の外観。}
    \label{fig:MAIKo}
  \end{minipage}
  \begin{minipage}{0.4\columnwidth}
    \centering
    \includegraphics[clip, width=0.8\columnwidth]{eps/upic_struc.eps}
    \caption{$\mu$-PIC の構造}
    \label{fig:uPIC}
  \end{minipage}
\end{figure}
...
(Fig. \ref{fig:MAIKo} 中では下向き) 飛跡を検出する。
