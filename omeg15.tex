...
\textcolor{red}{which} mean the maxpooling layer, convolutional layer~\textcolor{red}{\cite{conv}}, full connection layer, and dropout layer~\textcolor{red}{\cite{dropout}} respectively.
...
\textcolor{red}{which is the number of times that the learning sufficiently converges}.
